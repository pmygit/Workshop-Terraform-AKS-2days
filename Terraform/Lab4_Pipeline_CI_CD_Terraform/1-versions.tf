...
terraform {
  ...
  backend "azurerm" {
    resource_group_name  = "PMY-RG-AKSCluster"         # mettre ici le nom du resource group de vos ressource
    storage_account_name = "pmyterraformstan"      # mettre le nom du compte de stockage créer dans le lab 1
